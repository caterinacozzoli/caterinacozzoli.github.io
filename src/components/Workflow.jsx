...
const STEPS = {
  it: [
    ...
    { num: '03', title: 'Concept & AI',  desc: 'Esplorazione visiva rapida. Utilizzo i tool di intelligenza artificiale per generare i primi concept e moodboard.' },
    { num: '04', title: 'Wireframe',    desc: 'Strutture veloci, flussi testati. Schizzo prima di costruire.' },
    { num: '05', title: 'Prototipo',    desc: 'Alta fedeltà, micro-interazioni, sistema di design coerente.' },
    { num: '06', title: 'Test & Itera', desc: 'Osservo persone reali. Correggo, miglioro, ripeto.' },
  ],
  en: [
    ...
    { num: '03', title: 'Concept & AI',   desc: 'Rapid visual exploration. I leverage AI generative tools to quickly draft initial concepts and moodboards.' },
    { num: '04', title: 'Wireframe',      desc: 'Fast structures, tested flows. Sketch before building.' },
    { num: '05', title: 'Prototype',      desc: 'High fidelity, micro-interactions, coherent design system.' },
    { num: '06', title: 'Test & Iterate', desc: 'Watch real people. Fix, improve, repeat.' },
  ],
  pt: [
    ...
    { num: '03', title: 'Conceito & IA',   desc: 'Exploração visual rápida. Utilizo ferramentas de inteligência artificial para gerar os primeiros conceitos e moodboards.' },
    { num: '04', title: 'Wireframe',       desc: 'Estruturas rápidas, fluxos testados. Esboço antes de construir.' },
    { num: '05', title: 'Protótipo',       desc: 'Alta fidelidade, micro-interações, sistema di design coerente.' },
    { num: '06', title: 'Testar & Iterar', desc: 'Observo pessoas reais. Corrijo, melhoro, repito.' },
  ],
};
