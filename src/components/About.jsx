...
const POLAROIDS = [
  {
    id: 1,
    src:   '/images/polaroid/polaroid-contesto-parlamento.png',
    retro: '/images/polaroid/polaroid-retro-contesto-parlamento.png',
    caption: { it: 'Parlamento europeo', en: 'European Parliament', pt: 'Parlamento europeu' },
    description: {
      it: 'Bruxelles. In quelle sale enormi ho capito che il design non decora — decide. Da quel giorno ho smesso di chiedermi se ne valesse la pena.',
      en: 'Brussels. Walking those vast halls I understood: design doesn\'t decorate — it decides. That day I stopped doubting whether it was worth it.',
      pt: 'Bruxelas. Naquelas salas imensas entendi que o design não decora — decide. Desde esse dia, parei de me questionar se valia a pena.',
    },
    date: { it: 'Bruxelles, 2023', en: 'Brussels, 2023', pt: 'Bruxelas, 2023' },
  },
  { id: 2, src: null, retro: null, caption: null, description: null, date: { it: 'Milano, 2023',    en: 'Milan, 2023',      pt: 'Milão, 2023'    } },
  { id: 3, src: null, retro: null, caption: null, description: null, date: { it: 'Estate, 2023',    en: 'Summer, 2023',     pt: 'Verão, 2023'    } },
  { id: 4, src: null, retro: null, caption: null, description: null, date: { it: 'Milano, 2024',    en: 'Milan, 2024',      pt: 'Milão, 2024'    } },
  { id: 5, src: null, retro: null, caption: null, description: null, date: { it: 'Fortaleza, 2024', en: 'Fortaleza, 2024',  pt: 'Fortaleza, 2024'} },
  { id: 6, src: null, retro: null, caption: null, description: null, date: { it: 'Primavera, 2024', en: 'Spring, 2024',     pt: 'Primavera, 2024'} },
  { id: 7, src: null, retro: null, caption: null, description: null, date: { it: 'Estate, 2024',    en: 'Summer, 2024',     pt: 'Verão, 2024'    } },
  { id: 8, src: null, retro: null, caption: null, description: null, date: { it: 'Inverno, 2023',   en: 'Winter, 2023',     pt: 'Inverno, 2023'  } },
];
...
function PolaroidCard({ src, retro, caption, description, date, index, lang }) {
    ...
    >
      <div className="polaroid-inner">
        ...
        <div
          ...
          aria-hidden="true"
          style={retro ? { backgroundImage: `url(${retro})` } : undefined}
        >
          {descStr && (
            <span className="polaroid-description">{descStr}</span>
          )}
          <time className="polaroid-date">{dateStr}</time>
        </div>
      </div>
    </button>
  );
        ...
        >
          {POLAROIDS.map((p, i) => (
            <li key={p.id} className="about-carousel-item">
              <PolaroidCard src={p.src} retro={p.retro} caption={p.caption} description={p.description} date={p.date} index={i} lang={lang} />
            </li>
          ))}
        </ul>
      </div>
